...
namespace TestOgSikkerhed.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                // Use the login service instead of directly using SignInManager
                var result = await _loginService.LoginLoginService(
                    Input.Email, 
                    Input.Password, 
                    Input.RememberMe, 
                ...
                if (result.Succeeded)
                {
                    ...
                    // Instead of redirecting to the return URL, always redirect to 2FA
